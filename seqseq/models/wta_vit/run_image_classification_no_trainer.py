...
from huggingface_hub import HfApip
...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Approximation configuration in JSON format.",
    )
...
def main():
    ...
    approx_config = json.loads(args.approx_config) if args.approx_config is not None else None
    ...
    for epoch in range(starting_epoch, args.num_train_epochs):
        ...
        for step, (indexs, inputs) in enumerate(active_dataloader):
